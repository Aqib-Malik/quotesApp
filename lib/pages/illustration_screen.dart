...
class IllustrationScreen extends StatefulWidget {
  const IllustrationScreen({Key? key, required this.bg, required this.name})
      : super(key: key);
  final String bg;
  final String name;
  @override
  State<IllustrationScreen> createState() => _IllustrationScreenState();
}
